...
(define_attr "cpu"
  "ppc601,ppc603,ppc604,ppc604e,ppc620,ppc630,
   ...
   ppc403,ppc405,ppe405,ppe42,ppe42x,ppc440,ppc476,
...
;; On PPE42, Prevent compiler from generating an unaligned memory access using
;; lhz to optimize a 8 bit shift and 16 bit mask
(define_insn ""
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r")
	(zero_extend:SI (match_operand:HI 1 "memory_operand" "m")))]
  "(TARGET_PPE)&&
   (GET_CODE(XEXP(operands[1],0))==PLUS)&&
   (INTVAL(XEXP(XEXP(operands[1],0),1))==1)"
  "*
{
    {
        static char buf[80];
        int r2 = REGNO(XEXP(XEXP(operands[1],0),0));
        sprintf(buf,\"### lhz %%0 %%1\;lwz %%0,0(%d)\;rlwinm %%0, %%0,24,16,31\",r2);
        return buf;
    }
}"
	[(set_attr "type" "load")
...
;; PPE42X load stack instruction
(define_insn "lsku"
  [(set (match_operand:SI 0 "gpc_reg_operand" "=r")
	(match_operand:SI 1 "memory_operand" "m"))]
  "TARGET_PPE42X_STACK && REGNO (operands[0]) == STACK_POINTER_REGNUM &&
   REGNO (SET_DEST(operands[1])) == STACK_POINTER_REGNUM"
  "## restore regs/remove stackframe  %1"
  [(set_attr "length" "0")])
...
;;  ""
;;;;  "div<wd>u %0,%1,%2"
;;   "*return \"mr 3,%1\;mr 4,%2\;bl __udiv<mode>3\;mr %0,3\";"
...
;;  ""
;;  "div<wd> %0,%1,%2"
;;  "*return \"mr 3,%1\;mr 4,%2\;bl __div<mode>3\;mr %0,3\";"
;;  [(set_attr "type" "<idiv_ldiv>")])
  ...
  "
{
  ...
  if ((TARGET_POWERPC64 || TARGET_PPE42X) && GET_MODE (operands[0]) == DImode)
...
(define_insn "insvdi_internal"
  ...
  "TARGET_POWERPC64 || TARGET_PPE42X"
  "*
{
  ...
  "
{
  ...
  if ((TARGET_POWERPC64 || TARGET_PPE42X) && GET_MODE (operands[1]) == DImode)
...
(define_expand "ashldi3"
  ...
  "TARGET_POWERPC64 || TARGET_PPE42X"
  {
    if (TARGET_PPE42X && GET_CODE(operands[2]) == CONST_INT)
    {
      if(INTVAL(operands[2]) == 32)
        FAIL; /* compiler generates better code without ashldi3 for this case */
    }
  })
...
(define_insn "*slvd"
  ...
  slvd %0,%1,%2
  sldi %0,%1,%H2"
  [(set_attr "type" "var_shift_rotate,shift") (set_attr "length" "4,4")])
  ...
  "TARGET_POWERPC64 || TARGET_PPE42X"
{
  ...
  {
    if(INTVAL(operands[2]) == 32)
      FAIL;  /* compiler generates better code without lshrdi3 for this case */
  }
})
...
(define_insn "movsi_update"
  [(set (mem:SI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "0,0")
   ...
   (set (match_operand:SI 0 "gpc_reg_operand" "=b,b")
	(plus:SI (match_dup 1) (match_dup 2))) (clobber (reg:SI    0))]
  "TARGET_UPDATE
   && (!avoiding_indexed_address_p (SImode)
       || !gpc_reg_operand (operands[2], SImode)
       || (REG_P (operands[0])
	   && REGNO (operands[0]) == STACK_POINTER_REGNUM))"
  "@
   mfmsr 0\;wrteei 0\;stwx %3,%0,%2\;add %0,%0,%2\;mtmsr 0;## DYNAMIC STACK update
   stwu %3,%2(%0)"
  [(set_attr "type" "store_ux,store_u")
...
(define_insn "movsi_update_stack"
  ...
  ""
  "@
   mfmsr 0\;wrteei 0\;stwx %3,%0,%2\;add %0,%0,%2\;mtmsr 0;## PPE42 DYNAMIC STACK Adjust
   stwu %3,%2(%0)"
  [(set_attr "type" "store_ux,store_u")
   (set_attr "length" "20,4")])
...
(define_insn "*stmw"
  [(match_parallel 0 "stmw_operation"
		   [(set (match_operand:SI 1 "memory_operand" "=m")
       			 (match_operand:SI 2 "gpc_reg_operand" "r"))])]
  "TARGET_MULTIPLE && !TARGET_PPE"
  "stmw %2,%1"
  [(set_attr "type" "store_ux")])

(define_insn "*stvd"
  [(match_parallel 0 "stvd_operation"
		   [(set (match_operand:SI 1 "memory_operand" "=m")
       			 (match_operand:SI 2 "gpc_reg_operand" "r"))])]
  "TARGET_PPE"
  "stvd %2,%1## stvd parallel"
  [(set_attr "type" "store_ux")])
...
; various ABIs (r9, r1, and for some functions r10)

(define_insn "*save_gpregs_<mode>_r9"
...
(define_insn "*save_gpregs_<mode>_r10"
  [(match_parallel 0 "any_parallel_operand"
		   [(clobber (reg:P 65))
		    (use (match_operand:P 1 "symbol_ref_operand" "s"))
                    (use (reg:P 10))
...
(define_insn "*save_fpregs_<mode>_r9"
  [(match_parallel 0 "any_parallel_operand"
		   [(clobber (reg:P 65))
		    (use (match_operand:P 1 "symbol_ref_operand" "s"))
                    (use (reg:P 9))
...
;; This explains what PPE42X instruction stsku does.
;; The Pattern only matches the store and update of sp, and store of lr
;; Optional store(s) of GPR d28/d30 follow.
(define_insn "*stsku"
  [(match_parallel 0 "stsku_operation"
    [(set (mem:SI (plus:SI (match_operand:SI 1 "gpc_reg_operand" "r")
                           (match_operand:SI 2 "reg_or_short_operand" "I")))
	        (match_operand:SI 3 "gpc_reg_operand" "r"))
     (set (match_operand:SI 4 "gpc_reg_operand" "=b")
	        (plus:SI (match_dup 1) (match_dup 2)))
     (set (match_operand:SI 5 "memory_operand" "=m")
          (match_operand:SI 6 "register_operand" "l"))
    ])]
"TARGET_PPE42X_STACK"
"stsku %1,%2(%1); ## stwu  %1,%2(%1); stw %6,%5 and save gprs listed."
  [(set_attr "type" "store_u") (set_attr "length" "4")])


;; This explains what PPE42X instruction lsku does before it modifies
;; the stack pointer
(define_insn "*lsku emit"
  [(match_parallel 0 "lsku_operation"
    [(set (match_operand:SI 1 "register_operand" "=l")
          (mem:SI (plus:SI (match_operand:SI 2 "gpc_reg_operand" "r")
                           (match_operand:SI 3 "reg_or_short_operand" "I")))
     )])]
  "TARGET_PPE42X_STACK"
  "lsku %2,%3(%2) ##; equiv. addi %2,%2,%3; lwz %1,4(%2); if saved then lvd d30,-8[%2]; lvd d28,-16[%2]"
  [(set_attr "type" "load") (set_attr "length" "4")])
...
(define_insn "*lvd"
  [(match_parallel 0 "lvd_operation"
		   [(set (match_operand:SI 1 "gpc_reg_operand" "=r")
       			 (match_operand:SI 2 "memory_operand" "m"))])]
  "TARGET_PPE"
  "lvd %1,%2##lvd parallel"
  [(set_attr "type" "load_ux")])
...
; optimization will not try to rename this register.
; Each pattern is repeated for each possible register number used in 
; various ABIs (r9, r1, and for some functions r12)

(define_insn "*restore_gpregs_<mode>_r9"
 [(match_parallel 0 "any_parallel_operand"
...
(define_insn "*restore_gpregs_<mode>_r10"
 [(match_parallel 0 "any_parallel_operand"
                  [(clobber (match_operand:P 1 "register_operand" "=l"))
                   (use (match_operand:P 2 "symbol_ref_operand" "s"))
                   (use (reg:P 10))
...
(define_insn "*return_and_restore_gpregs_<mode>_r9"
 [(match_parallel 0 "any_parallel_operand"
                  [(return)
		   (clobber (match_operand:P 1 "register_operand" "=l"))
		   (use (match_operand:P 2 "symbol_ref_operand" "s"))
...
(define_insn "*return_and_restore_gpregs_<mode>_r10"
 [(match_parallel 0 "any_parallel_operand"
                  [(return)
		   (clobber (match_operand:P 1 "register_operand" "=l"))
		   (use (match_operand:P 2 "symbol_ref_operand" "s"))
...
(define_insn "*return_and_restore_fpregs_<mode>_r9"
 [(match_parallel 0 "any_parallel_operand"
                  [(return)
		   (clobber (match_operand:P 1 "register_operand" "=l"))
		   (use (match_operand:P 2 "symbol_ref_operand" "s"))
...
(define_insn "*return_and_restore_fpregs_aix_<mode>_r9"
 [(match_parallel 0 "any_parallel_operand"
		  [(return)
